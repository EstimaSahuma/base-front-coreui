...
@Component({
  selector: 'app-listar-historico-manutencao',
  standalone: true,
  imports: [
    CommonModule,
    TableModule,
  ...
  templateUrl: './listar-historico-manutencao.component.html',
  styleUrl: './listar-historico-manutencao.component.scss'
})
export class ListarHistoricoManutencaoComponent implements OnInit {
  ...
  public listarEquipamentos() {
    ...
    this.manutencaoEquipamentosService.list(httpParams).subscribe(data => {
